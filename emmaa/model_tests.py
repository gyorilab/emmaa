...
class ModelManager(object):
    ...
    ----------
    mc_types : list[str]
        A list of ModelCheckers for running tests and queries.
    {mc_type}_model : pysb.Model, pybel.BELGraph, networkx.DiGraph or
                      networkx.MultiDiGraph
        Model of a specified type assembled from EMMAA model.
    {mc_type}_model_checker : indra.explanation.model_checker.ModelChecker
        A ModelChecker of a specified type.
    {mc_type}_test_results : list[indra.explanation.model_checker.PathResult]
        A list of EMMAA test results generated by a given ModelChecker.
