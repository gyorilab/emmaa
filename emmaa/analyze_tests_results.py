...
class TestRound(object):
    ...
    mc_types : list[str]
        A list of ModelCheckers used for running the tests.
    mc_support : bool
        ...
        results.
    {mc_type}_test_results : list[indra.explanation.model_checker.PathResult]
        A list of EMMAA test results generated by given ModelChecker.
